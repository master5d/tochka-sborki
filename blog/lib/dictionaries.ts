// SHARED CHROME — mirror of hub/lib/dictionaries.ts. Keep in sync; see docs/superpowers/specs/2026-06-02-blog-split-design.md
    ...
    projects: [
      {
        ...
        href: 'https://ai.synergify.com/en/',
