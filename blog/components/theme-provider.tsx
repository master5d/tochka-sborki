'use client'
// SHARED CHROME — mirror of hub/components/theme-provider.tsx. Keep in sync; see docs/superpowers/specs/2026-06-02-blog-split-design.md
...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  // Follow the OS live while pref is "system". Keyed on `pref` so the listener
  // tears down once an explicit light/dark is chosen.
  useEffect(() => {
