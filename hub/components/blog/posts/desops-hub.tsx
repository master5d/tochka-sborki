...
export function DesOpsHub({ locale }: Props) {
  ...
  return (
    <div className={styles.prose}>
      ...
      <h2>10. Смерть Handoff: Onlook</h2>
      <p>
      ...
      <ul>
        ...
        <li><b>Visual Production:</b> Дизайнер (или агент) работает прямо в продакшн-кодбазе. Больше нет "перерисовок" с нуля — дизайн и код стали единым целым.</li>
      ...
      <h2>12. Контроль Качества: Impeccable 3.5</h2>
      <p>
      ...
      <h2>13. Новый Коэффициент: От Измеримого к Магическому</h2>
      <p>
      ...
      <h2>14. Архитектура Суверенитета: Паттерны Будущего</h2>
      <p>
