...
export function DesOpsHub({ locale }: Props) {
  ...
  return (
    <div className={styles.prose}>
      ...
      <h2>6. Когнитивная Визуализация: PaperBanana</h2>
      <p>
      ...
      <p>
        {'Система запускает «креативный отдел» из 5 агентов: Retriever находит структуру в топ-публикациях (NeurIPS), Planner строит чертеж, Stylist подбирает палитру, а Visualizer и Critic доводят результат до идеала за 3 раунда рефлексии.'}
      </p>
