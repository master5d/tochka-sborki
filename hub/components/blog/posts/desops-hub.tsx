...
export function DesOpsHub({ locale }: Props) {
  ...
  return (
    <div className={styles.prose}>
      ...
      <p>
        {'Мы наблюдаем фундаментальный сдвиг: дизайн перестает быть отдельной профессией и превращается в <b>загружаемый навык</b> для вашего код-агента. Проекты вроде <b>open-design</b> позволяют Claude Code или Cursor подгружать 30+ дизайн-скиллов и 70+ топовых брендовых систем в один клик.'}
      </p>

      <h2>5. «Я скачал себе дизайнера»: Дизайн-Протоколы</h2>
      <p>
        {'Ключевой инсайт последних месяцев — использование <b>Дизайн-Протоколов</b> (например, методологии <b>huashu-design</b>). Мы загружаем методологию как скилл, и агент начинает действовать системно, как по «еб***ему протоколу».'}
      </p>
      <ul>
        <li><b>Self-Correction Loop:</b> Агент больше не отдает результат «как есть». Он проводит 5-уровневое само-ревью по 20+ принципам дизайна, исправляя ошибки до того, как их увидите вы.</li>
        <li><b>Proactive Orchestration:</b> Генерирует варианты дизайна, презентации и даже документацию на основе контекста.</li>
        <li><b>Human as Curator:</b> Роль человека — арбитраж вкуса и финальная сборка из лучших AI-вариантов.</li>
      </ul>
      ...
      <h2>8. Архитектурный Элитизм: Pretext и OpenPencil</h2>
      <p>
