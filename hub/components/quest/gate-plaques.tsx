...
import { ART_SIZES, GATE_PLAQUES, type PlaqueBox } from '../../lib/quest/scenes'
 ...
 * Always drawn inside a road's cover box, so its srcset uses ART_SIZES.road.
 */
export function GatePlaques({ locale, plaques, quip }: Props) {
  return (
    <SceneLoop id="05-gates" locale={locale} quip={quip} sizes={ART_SIZES.road}>
