...
export function ActThree({ locale }: Props) {
  ...
  return (
    <section className={styles.section}>
      ...
      <p>
        {'И сразу честно: это не достижение. Это не диплом, который ты однажды'}
        ...
        {' может быть другое. Не форма важна — важно, что ты раз за разом возвращаешься в это место'}
        {' внутри. Через это место проходит дверь в инструмент. Не через подписку, не'}
