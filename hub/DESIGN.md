...
- 2026-09-11/12 (владелец): главная = **пол** (model-kit, прежний лендинг) + **обложка** `trend-adweek-2026-09` (тема quest) как витрина без переключателя; смена обложки только на бекэнде по команде владельца (спек 2026-09-11-site-covers-floor-ab). Обложка — авторский синтез по тренду, не клон. Мир обложки в 2K (широкие hero/финал), `srcset` @1x/@2x, без растяжения по одной оси.
